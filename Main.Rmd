...
#TODO: Change county to "County, ST"
#TODO: Update ReadMe
#TODO: Note that this refreshes automatically
...
The COVID-19 data begins with the first reported coronavirus case in Washington State on Jan. 21, 2020. The New York Times updates its data regularly (as of mid-April, the update is daily), but this dashboard does not automatically retrieve the latest New York Times data. Data was last retrieved on the date listed at the top of this page.
